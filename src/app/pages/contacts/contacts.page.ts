...
export class ContactsPage implements OnInit {
  ...
  ngOnInit() {
    ...
    // 4) Cria os campos do formulÃ¡rio
    this.contactFormCreate();

  }

  // 5) Cria os campos do formulÃ¡rio
  contactFormCreate() {
    ...
    this.contactForm = this.form.group({
      ...
      email: [
        ...
        Validators.compose([  // Valida campo
          Validators.required,  // Campo obrigatÃ³rio
          Validators.email,  // Deve ser um e-mail vÃ¡lido
          removeSpaces // Remove espaÃ§os duplicados
        ])
      ],
  ...
  // 7) Processa envio do formulÃ¡rio
  contactSend() {
  ...
  async feedback() {
    const alert = await this.alert.create({
      ...
      message: 'Seu contato foi enviado para o "Bonecos".', // Mensagem do alert
      buttons: [
        ...
        // botão [Ok] e sua aÃ§Ã£o
        {
          ...
          handler: () => {  // AÃ§Ã£o do botão
            ...
            // Reset do formulÃ¡rio, mantendo nome e e-mail jÃ¡ usados
